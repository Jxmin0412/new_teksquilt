...
const values = [
  ...
  },
  {
    ...
    description:
      "Every placement is about people - understanding their goals, skills, and aspirations.",
  ...
  },
  {
    ...
    title: "Excellence",
    description:
      "We strive for excellence in our services, continuously improving and innovating.",
  ...
  },
  {
    ...
    description:
      "Embracing diversity and inclusion while connecting talent across borders.",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              For over 15 years, TekSquilt has been the bridge between
              exceptional talent and innovative companies. We believe in the
              power of perfect matches to transform careers and businesses.
            </p>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To revolutionize talent acquisition by creating meaningful
                    connections between exceptional professionals and
                    forward-thinking companies. We go beyond traditional
                    recruitment, focusing on cultural fit, growth potential, and
                    long-term success.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To be the global leader in talent solutions, known for our
                    innovative approach, unwavering integrity, and commitment to
                    transforming careers and businesses through perfect talent
                    matches.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Join hundreds of companies that trust TekSquilt for their talent
              acquisition needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
